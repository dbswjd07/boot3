...
class Boot03ApplicationTests {
	...
	public void testByTitleAndBno() {
		//Collection<BoardVO> blist = this.boardRepo.findByTitleContainingAndBnoGreaterThan("5", 20);
		//blist.forEach(b -> System.out.println(b));
	}//TestByTitleAndBno()
	...
	public void testByTitle2() {
		//this.boardRepo.findByTitle("재목").forEach(b->System.out.println(b));
	}
